...
extension Recon {
    ...
    public func setOverrides(from string: String) throws {
        // A valid non-empty export always contains literal | separators.
        // If none are present the payload was percent-encoded again in
        // transit (e.g. passed through a URL or web form, so | became
        // %7C); decoding once cleanly undoes that transport layer.
        ...
        let entries = normalized.split(separator: "&", omittingEmptySubsequences: true)
